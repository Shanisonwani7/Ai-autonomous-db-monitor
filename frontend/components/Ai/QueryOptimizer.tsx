...
export default function QueryOptimizer() {
  ...
  return (
    <div className="w-full rounded-3xl overflow-hidden bg-[#0B0F19] text-gray-100 p-6 md:p-8 lg:p-12 selection:bg-purple-500/30">
      <motion.div 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <motion.div variants={itemVariants} className="lg:col-span-5 space-y-6">
            <div className="relative group">
              <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-500/30 to-purple-600/30 rounded-2xl blur opacity-30 group-hover:opacity-50 transition duration-500"></div>
              <div className="relative bg-[#131B2C] border border-white/10 rounded-2xl p-4 overflow-hidden flex flex-col h-[400px]">
                <div className="flex items-center space-x-2 mb-3 px-2">
                  ...
                  <span className="text-sm font-medium text-gray-300">Input Query</span>
                </div>
                <textarea 
          ...
          <motion.div variants={itemVariants} className="lg:col-span-7 space-y-6">
            ...
            <div className="bg-[#131B2C] border border-white/5 rounded-2xl p-6 space-y-5">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400 font-medium">Optimized Query</span>
                    <span className="text-purple-400 font-mono font-medium">55%</span>
                  </div>
                  <div className="w-full h-2.5 bg-gray-800 rounded-full overflow-hidden">
                    <motion.div 
                      initial={{ width: 0 }}
            ...
            <div className="bg-[#131B2C] border border-white/5 rounded-2xl overflow-hidden shadow-lg">
              <div className="bg-[#1C2438] px-4 py-3 border-b border-white/5 flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-medium text-gray-200">Optimized Query</span>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                .map((suggestion, idx) => (
                  <motion.div 
                    ...
                    className="bg-white/[0.02] hover:bg-white/[0.04] border border-white/5 hover:border-white/10 p-4 rounded-xl flex items-start space-x-3 transition-all cursor-default"
                  >
