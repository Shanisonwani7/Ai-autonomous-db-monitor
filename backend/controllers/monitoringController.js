...
exports.getDatabaseVersion = async (req, res) => {
  ...
  const result =
    await monitoringService.getDatabaseVersion(
      id,
      req.user.id
    );
...
exports.getDashboardMetrics = async (req, res) => {
  ...
  const result =
    await monitoringService.getDashboardMetrics(
      id,
      req.user.id
    );
...
exports.getRunningQueries = async (req, res) => {
  ...
  const result =
    await monitoringService.getRunningQueries(
      id,
      req.user.id
    );
...
exports.getDatabaseLocks = async (req, res) => {
  ...
  const result =
    await monitoringService.getDatabaseLocks(
      id,
      req.user.id
    );
...
exports.getSlowQueries = async (req, res) => {
  ...
  const result =
    await monitoringService.getSlowQueries(
      id,
      req.user.id
    );
...
exports.getLongRunningTransactions = async (
  req,
  res
) => {
  const id = parseId(req.params.id);
  ...
  const result =
    await monitoringService.getLongRunningTransactions(
      id,
      req.user.id
    );
...
exports.getIdleSessions = async (req, res) => {
  ...
  const result =
    await monitoringService.getIdleSessions(
      id,
      req.user.id
    );
...
exports.getDatabaseStatistics = async (
  req,
  res
) => {
  const id = parseId(req.params.id);
  ...
  const result =
    await monitoringService.getDatabaseStatistics(
      id,
      req.user.id
    );
...
exports.getMonitoringHistory = async (
  req,
  res
) => {
  const id = parseId(req.params.id);
...
exports.getTrendAnalysis = async (
  req,
  res
) => {
  const id = parseId(req.params.id);
